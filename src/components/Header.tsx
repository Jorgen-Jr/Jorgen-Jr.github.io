...
const Header = ({ slide }: IProps) => {
  ...
  return (
    <Box>
      <MotionFlex
        initial={isAtTop ? { x: -20, opacity: 0 } : { x: 0, opacity: 1 }}
        animate={{
          x: [isAtTop ? -20 : 0, 0],
        ...
        background={
          isAtTop
            ? "none"
            : useColorModeValue("RGBA(255,255,255,0.8)", "RGBA(0,0,0,0.6)")
        }
            ...
            {links.map((link, index) => (
              ...
              >
                <Link
                  ...
                  color={
                    link.active ? "#C000C4" : useColorModeValue("black", "#DDD")
                  }
                  style={{
                    fontWeight: "bolder",
                    width: "full",
              ...
              {links.map((link, index) => (
                ...
                >
                  <Link
                    ...
                    color={
                      link.active
                        ? useColorModeValue("#003761", "#0274cc")
                        : useColorModeValue("black", "#DDD")
                    }
                    fontWeight="bolder"
                    _hover={{
