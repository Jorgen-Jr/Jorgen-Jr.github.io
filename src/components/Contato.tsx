        ...
        <Flex justifyContent="center" flexDirection="column">
            ...
            <Flex justifyContent="center">
                <Box
                    ...
                    m={["15px", "0"]}
                >
                    <Text>Vamos conversar sobre o nosso próximo projeto?</Text>
                </Box>
            </Flex>
            ...
            <Text mt="10px" mb="10px" color="#555" fontSize="16px">
              XXXXX@xxxxxxxxx.com.br
                ...
                <form
                    name="contato"
                    method="POST"
                    action="https://jorgenjr.netlify.app/successo/"
                    data-netlify="true"
                ...
                >
                    ...
                    >
                        <Input
                            ...
                            color={useColorModeValue("#053a63", "#eaeaea")}
